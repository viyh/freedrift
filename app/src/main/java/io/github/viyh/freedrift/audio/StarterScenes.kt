...
object StarterScenes {
    ...
    private const val STARTERS_VERSION = 6
    ...
    private val specs = listOf(
        Spec("Japanese Garden", listOf(
            LayerSpec("windchimesbamboo", 0.60f),
            LayerSpec("windchimeslow", 0.70f),
            LayerSpec("waterfountain", 0.30f),
            LayerSpec("birdshigh", 0.20f),
        )),
